...
/**
 * Represents category in CategoryTree. You can access it's parent via getParent
 * and it's subcategories via getSubcategories().
 */
public class Category {
	...
	// fields ///////////////////////////////////////////////////////////////
	/**
	 * unambiguously identifies category. mId must be unique in the whole
	 * CategoryTree (mTree).
	 */
	private int mId;
	/**
	...
	/**
	 * Category for which this category is direct subcategory. If mParent is null,
	 * then it is root category.
	 */
	@Nullable
	private Category mParent;
	/**
	 * Tree of categories to which this category belongs. It is used to check
	 * whether category id is unique in whole tree.
	 */
	@NotNull
	...
	/**
	 * @throws IllegalArgumentException if name is an empty string or a string that
	 ...
	 */
	public Category(int id, @NotNull String name, @NotNull CategoryTree tree) {
		if (name.trim().isEmpty())
			throw new IllegalArgumentException(BAD_NAME_EXCEPTION);

		mId = id;
		// if category is not unique in tree throw exception
		if (!tree.addCategory(this))
			throw new NonUniqueCategoryException();
	 ...
	 * @return true if category was successfully added, false if category is not
	 *         unique in current category tree or is from different tree than parent
	 */
	 ...
	 * @return true if category was successfully removed, false if category with
	 *         such id was not found
	 */
	...
	/**
	 * @return true if category hasn't got any subcategories, false if category has
	...
	/**
	 * @return true, if the category hasn't got parent, false otherwise
	 */
	...
	/**
	 * @return string representing Javascript array, that contains all subcategories
	 *         of this category
	 */
	 ...
	 * 
	 * @param parent
	 * @return true if successfully added, false otherwise (new parent is in
	 *         different tree)
	 */
	 ...
	 * 
	 * @param newName
	 * @return true if successfully updated, false if name was invalid or couldn't
	 *         update in database
	 */
