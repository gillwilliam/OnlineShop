...
<%
	...
	seller.setName(request.getParameter(application.getInitParameter("name")));
	seller.setSurname(request.getParameter(application.getInitParameter("surname")));
	...
	if (seller.getName() == null) seller.setName("");
	if (seller.getSurname() == null) seller.setSurname("");
	if (seller.getPhone() == null) seller.setPhone("");
	if (seller.getEmail() == null) seller.setEmail("");
	if (seller.getPassword() == null) seller.setPassword("");
	...
	CreateSellerRequestHandler.InputValidationResult validationResult =
		(CreateSellerRequestHandler.InputValidationResult) request
	...
	CreateSellerRequestHandler.AddToDBResult updateResult = 
			(CreateSellerRequestHandler.AddToDBResult) request.
...
<div id="container">
    ...
    <div id="message_box" class="<%= validationResult == null ? "invisible" : "" %>"
            ...
            <span id="message">
                <%= validationResult != null && validationResult.isValid() &&
            			updateResult != null && updateResult.isUpdateSuccessful ? 
            					"" 
            					:
                        		"Errors occurred during data update. " + (updateResult == null ? 
                        				""
                        				:
    ...
    <form id="user_data_form" action="${pageContext.request.contextPath}/createSeller.main" method="post">
